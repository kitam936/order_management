...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">MyOrder詳細</h2>
            <div class="flex">
                    ...
                    <tbody>
                        <tr v-for="order_f in order_fs" :key="order_f.detail_id">
                            ...
                            <td class="border-b-2 border-gray-200">
                                <Link class="text-indigo-500" :href="route('reports.my_index', { id: order_f.detail_id })">{{ order_f.detail_id }}</Link>
                            </td>
