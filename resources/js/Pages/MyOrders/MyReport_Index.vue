...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">My作業詳細/Report一覧</h2>
            ...
            <div class="flex mt-4">
                ...
                <div class="ml-24 mb-0">
                    <Link as="button" :href="route('orders.my_order_index')" class="w-32 h-8 bg-indigo-500 text-sm text-white ml-0 hover:bg-indigo-600 rounded">MyOrder一覧</Link>
                </div>
                </div>
        </template>
                        ...
                        <table class="bg-white table-auto w-full text-center whitespace-no-wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th class="w-2/12 md:1/13 md:px-4 py-1 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">report</th>
                            ...
                            <tbody>
                                <tr v-for="report in reports" :key="report.id">
                                    <td class="border-b-2 boder-gray-200">
                                        <Link class="text-indigo-500" :href="route('reports.show2',{report:report.report_id})">{{ report.created_at  }} </Link>
                                    </td>
